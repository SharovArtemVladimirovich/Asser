...
namespace {
struct qt_meta_tag_ZN5testsE_t {};
} // unnamed namespace
...
Q_CONSTINIT static const uint qt_meta_data_ZN5testsE[] = {
...
Q_CONSTINIT const QMetaObject tests::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN5testsE.offsetsAndSizes,
    qt_meta_data_ZN5testsE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN5testsE_t,
        // Q_OBJECT / Q_GADGET
...
void *tests::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN5testsE.stringdata0))
